Ниже представлена объединённая и дополненная версия статьи, в которую органично интегрированы англоязычные фрагменты о разъёмах. Все разделы переведены и сведены в единый связный текст на русском языке.
